...
切换电脑前先提交并推送；另一台电脑开始工作前先拉取 `main`。详细合同见 [架构说明](docs/ARCHITECTURE.md)、[开发说明](docs/DEVELOPMENT.md) 和 [1.1.0 人工验收清单](docs/MANUAL_ACCEPTANCE_1.1.0.md)。`1.1.0` 为待验收版本，正式发布前请继续使用 Releases 中的最新正式版本。
