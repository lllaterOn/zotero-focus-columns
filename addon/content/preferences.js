var FocusColumnsPreferences = {
  ...
  strings: {
    "zh-CN": {
      ...
      syncViewGroups: "同步插件设置包含视图组名称、组的排列和列的显隐顺序；列宽和当前视图组仅保存在本机。同步视图组前，请将两台电脑都升级到 Focus Columns 1.2.0 或更高版本。",
      syncCheck: "立即检查同步数据",
    ...
    "en-US": {
      ...
      syncViewGroups: "Plugin settings include view-group names, group order, and column visibility and order; widths and the active group stay on this computer. Upgrade both computers to Focus Columns 1.2.0 or later before synchronizing view groups.",
